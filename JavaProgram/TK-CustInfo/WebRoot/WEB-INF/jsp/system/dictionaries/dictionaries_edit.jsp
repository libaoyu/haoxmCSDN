				...
				<div class="row">
					...
					<form action="dictionaries/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="margin-top:15px;">
							...
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">是否关联部门：</td>
								<td>
								是：<input type="radio" name="ISDEPARTMENT" value="1" onclick="isdeparementDiv(1)">
								否：<input type="radio" name="ISDEPARTMENT" value="0" onclick="isdeparementDiv(0)">
								<div id="deparementDiv" style="display:none">
									<input type="hidden" name="DEPARTMENT_ID" id="DEPARTMENT_ID" value="${pd.DEPARTMENT_ID}"/>
									<input type="hidden" name="DEPARTMENT_PATH" id="DEPARTMENT_PATH" value="${pd.DEPARTMENT_PATH}"/>
									<div style="float: left" class="selectTree" id="selectTree"></div>
								</div>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function isdeparementDiv(obj){
			if(obj == '1'){
				$("#deparementDiv").css("display","block");
			}else{
				$("#deparementDiv").css("display","none");
				$("#DEPARTMENT_ID").val("");
				$("#DEPARTMENT_PATH").val("");
			}
		}
