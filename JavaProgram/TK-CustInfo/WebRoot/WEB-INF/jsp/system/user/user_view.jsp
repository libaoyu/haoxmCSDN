						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">所属部门:</td>
											<td>
												<input type="text" name="DEPARTMENTNAME" id="DEPARTMENTNAME" value="${pd.DEPARTMENT_NAME}" style="vertical-align:top;" style="width:98%;" disabled="disabled">
											</td>
										</tr>
										<c:if test="${fx != 'head'}">
										<tr>
