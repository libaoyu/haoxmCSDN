...
$(function(){
	$.post("qResult/findDefaultData",function(data){
		if(data!=null && data!=''){
			setChart(data);
		}
	})
...
function setChart(data){
	var myChart = echarts.init(document.getElementById('questionAll'));
	option = {
		    title : {
		        text: '问卷系统统计总揽',
		        subtext: '问卷总数:'+data.legendData.length+'份/参与问卷调查总人数:'+data.count+"人",
		        x:'center'
		    },
		    tooltip : {
		        trigger: 'item',
			...
			<div id="page-content" class="clearfix">
				...
				<div class="space-6"></div>
					<div class="row-fluid">
						...
						<!-- 柱状图 -->
						<div class="center">
							<div style="height:550px;" id="questionAll">
