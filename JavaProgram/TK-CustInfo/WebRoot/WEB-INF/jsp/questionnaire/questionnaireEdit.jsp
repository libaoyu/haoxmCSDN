...
<body>
	<form action="questionnaire/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:20%;text-align: right;padding-top: 13px;">背景图片:<br/><font style="color: red;">高x宽(1169*640)</font></td>
				<td style="width:70%;" colspan="3">
					<div id="preview">
						<a href="javascript:void"><img alt="background" name="backgroundImgPath" id="backgroundImgPath" style="width: 100px;height: 100px;" src="<%=basePath %>${pd.backgroundImgPath }"/></a>
						<input type="hidden" id="backgroundImgId" name="backgroundImgId" value="${pd.backgroundImgId }"/>
					</div>
					<input type="file" id="backgroundImgFile" style=" font-size: 15px; width:200px"  name="backgroundImgFile" onchange="changeImg(this,'backgroundImgPath')"/>
					<a style="height: 30px;width: 30px;padding: 3px;padding-left: 5px;" class=" btn-small btn-danger" onclick="deletePicture('backgroundImgId','backgroundImgPath');" title="删除图片" ><i class='icon-trash'></i></a>
				</td>
			</tr>
			<tr>
