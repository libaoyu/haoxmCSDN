...
<div class="main">
    <div class="div_bg01">
        <img class="bg_img" src="../static/weixin/img/bg03.jpg"/>
    </div>
    <div class="lose_div01">
        <p class="lose_p1">非常抱歉！</p>

        <p class="lose_p3">提交失败</p>
    </div>
    <div class="lose_data">
        <img class="lose_img02" src="../static/weixin/img/triangle.png" />
        <p class="lose_p4">预约失败可能由以下原因引起：</p>
        <ul class="lose_ul">
            <li>● 找不到请求页面</li>
            <li>● 输入的个人信息有误</li>
        </ul>
