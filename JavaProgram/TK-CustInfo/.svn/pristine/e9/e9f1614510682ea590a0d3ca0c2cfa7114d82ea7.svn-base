(function(){
    ...
    optionCreate.onclick = function () {
    	if (flag) {//alert('111');
            ...
            $(newLi).find("input[id='questionData_code_id_0_1']").attr("id","questionData_code_id_"+sl+"_1");
    		$(newLi).find("input[id='questionData_name_id_0_2']").attr("id","questionData_name_id_"+sl+"_2");
