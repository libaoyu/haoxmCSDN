...
public class DictionariesService implements DictionariesManager{
	...
	@Override
	public List<PageData> findHosiptalList(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("DictionariesMapper.findHosiptalList", pd);
	}
	
	public List<PageData>  findChildrenByBianma(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("DictionariesMapper.findChildrenByBianma", pd);
	}
	/**
	 * 根据名字查询父类的个数
	 * @param pd
	 ...
	 * @throws Exception
	 */
	public List<PageData>  findListCountByName(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("DictionariesMapper.findListCountByName", pd);
	}
	/**
	 * 根据名字查询父类的id及       各个调查对象对应的。code。及名字
	 * @param pd
	 * @return
	 * @throws Exception
	 */
	public List<PageData>  findListDataByName(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("DictionariesMapper.findListDataByName", pd);
	}
