...
public class DepartmentController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("LEVE", Integer.valueOf(pd.getString("LEVE"))+1);
		pd.put("PATH", pd.getString("PATH") +"/"+ pd.getString("BIANMA"));
	...
	public ModelAndView listAllDepartment(Model model,String DEPARTMENT_ID)throws Exception{
		...
		try{
			...
			String DEPARTMENTID = user.getDepartment().getDEPARTMENT_ID();
			JSONArray arr = JSONArray.fromObject(departmentService.listAllDepartment(DEPARTMENTID));
